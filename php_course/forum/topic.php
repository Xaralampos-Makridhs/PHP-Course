...
// Πάρε το ID του θέματος από το GET
if (isset($_GET['id'])) {
    $topic_id = (int)$_GET['id'];
} else {
    die("Δεν υπάρχει θέμα.");
}
...
<body>
    <h2>Topics: <?= htmlspecialchars($title) ?></h2>
    ...
    <?php while ($row = $posts->fetch_assoc()): ?>
        <div class="post">
            ...
            <!-- Αν ο χρήστης είναι ο συγγραφέας του post, δείξε κουμπί διαγραφής -->
